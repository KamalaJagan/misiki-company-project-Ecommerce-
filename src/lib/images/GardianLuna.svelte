...
<div class="grid grid-flow-row grid-cols-1 lg:grid-cols-2 mt-6 font-san-serif text-sm">
	<div>
		...
		<div class="hidden md:flex flex-row gap-5 mt-6 lg:ml-[28vh] justify-center items-center">
			...
			<img src="https://cdn.shopify.com/s/files/1/0666/9309/products/Guardian_Luna_Blue_Topaz_Necklace_1_1100x.jpg?v=1580811048" class="h-32 w-24 object-cover" alt="." />
			<img src="https://cdn.shopify.com/s/files/1/0666/9309/products/Guardian_Luna_Blue_Topaz_Necklace_2_1100x.jpg?v=1580811048" class="h-32 w-24 object-cover" alt="." />
			<img src="https://cdn.shopify.com/s/files/1/0666/9309/products/IMG_1711_2-cropped_1100x.jpg?v=1648501269" class="h-32 w-24 object-cover" alt="." />
			<img src="https://cdn.shopify.com/s/files/1/0666/9309/products/IMG_1774-cropped_1100x.jpg?v=1648501269" class="h-32 w-24 object-cover" alt="." />
		...
		<div class="mt-4 h-[54vh] w-[61vh] bg-gray-50">
			...
			<div class="grid grid-flow-row grid-cols-4">
				...
				<div class="">
					...
					<div class="hidden">
					<button class="flex flex-flow-row border-2 mt-3 w-32 py-1 px-2 justify-between gap-1 items-center"
						>Text choice<svg
							fill="none"
							viewBox="0 0 24 24"
							stroke-Width={1.5}
