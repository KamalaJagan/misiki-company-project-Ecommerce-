...
<div class="mt-10 text-center justify-center font-serif text-gray-700">
...
<div class="lg:h-[700px] h-auto bg:w-full font-sans-serif ">
	...
	<form action="#" class="space-y-4 mt-8">
		<div class="grid grid-cols-2 max-w-6xl">
			...
			<div>
				<label for="email" class="lg:ml-[27vh] text-base font-medium text-gray-900">Email</label>
				<input
					type="email"
					id="email"
		...
		<div>
			<label for="Phone number" class="lg:ml-[55vh]  text-base font-medium text-gray-900 "
				>Phone Number</label
			>
			<input
				type="Phone number"
		...
		<div class="sm:col-span-2">
			<label for="Message" class="lg:ml-[55vh]  text-base font-medium text-gray-900 "
				>Message</label
			>
			<textarea
				id="Message"
	...
	<p class="text-xs lg:ml-[55vh] mt-4">This site is protected by reCAPTCHA and the Google <a href="/" class="hover:underline">Privacy Policy</a> and <a href="/" class="hover:underline">Terms of Service</a> apply.</p>
</div>
<div class="justify-center text-center">
<button class=" text-center h-[6.5vh] text-white tracking-widest text-base w-[15vh] bg-slate-600">SEND</button>
</div>
...
<div class=" h-auto bg:w-full font-sans-serif mt-10">
	...
	>
		{#each blogs as blog, bx}
			<div>
				<img src={blog.image} class="lg:h-[48vh] mt-4 h-auto object-cover w-auto" alt="....." />
				<div class="py-4">
